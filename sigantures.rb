...
def make_key_pair
    ...
    256.times do |i|
        ...
        pub_1 = sha_256("#{priv_key}0#{i}")
        pub_2 = sha_256("#{priv_key}1#{i}")
        pub_key.push([pub_1, pub_2])
    end    
